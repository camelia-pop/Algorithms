...
class IndexPQ {
	...
	public:
		...
		// assump: i is in the priority queue
		inline Key keyAt(int i) const { return keys[i]; };
...
// friend functionstemplate <typename Key, typename Comparator = less<Key>>
template <typename Key, typename Comparator>
